...
function dayMood(){
    ...
    let morning = ["Доброе утро!", "Надеемся, вы сегодня выспались (っ˘ω˘ς)", "Мы сделали вам кофе (˘▽˘)っ♨", "Ну вот, опять утро ｡ﾟ･ (>﹏<) ･ﾟ｡",
    "Это снова вы (｡◕‿◕｡)"];
    ...
    let night = ["Доброй ночи!", "Не сидите до поздна (￣^￣)", "Интересный факт: Иногда ночь может вдохновить 🌚"];
